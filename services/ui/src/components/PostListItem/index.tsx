...
import { LikeResponse, PostResource } from "@repo/client/src";
...
const PostLikedButton: React.FunctionComponent<{ post: PostResource }> = (
  props
) => {
  const { post } = props;
...
const PostListItem: React.FunctionComponent<{
  routing: boolean;
  post: PostResource;
}> = (props) => {
  ...
  return (
    <div className="my-2 max-w-xl">
      ...
      <ConfirmDialog
        ...
        description={
          <pre className="max-w-xl overflow-x-auto">
